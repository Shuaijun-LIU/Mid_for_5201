"""
Experiment 1 (Environment 3): Original configuration
...
def main(alpha=0.1, gamma=0.9, exp_suffix="", grid_size=(20, 20), file_suffix="",
    ...
    """
    Run experiment 1 with Environment 3: F -> C
    ...
    print("=" * 60)
    print("Experiment 1 (Environment 3): Original Configuration")
    print("=" * 60)
    ...
    exp_name = f"env3_exp1{exp_suffix}"
    ...
    if save_visualization:
        ...
        plot_convergence(
            ...
            show_plot=False,
            title_suffix=f" - Experiment 1 (F -> C) - Environment 3 - {grid_str}"
        )
        ...
        plot_q_table_heatmap(
            ...
            show_plot=False,
            title=f" - Experiment 1 (F -> C) - Environment 3 - {grid_str}",
    ...
    print("\n" + "=" * 60)
    print("Experiment 1 (Environment 3) completed!")
    if early_stopped:
