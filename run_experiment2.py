"""
Experiment 2: Changed configuration (task requirement)
Initial state: A (index 0)
...
def main(alpha=0.1, gamma=0.9, exp_suffix="", file_suffix=""):
    ...
    print("=" * 60)
    print("Experiment 2: Changed Configuration")
    print("=" * 60)
    print("Initial state: A (index 0)")
    ...
    if file_suffix:
        exp_name = f"env1_exp2{file_suffix}"
        save_dir = "results/env1_exp2"  # Unified directory
    else:
        exp_name = f"env1_exp2{exp_suffix}"
...
def run_parameter_grid(alpha_list=[0.1], gamma_list=[0.9]):
    ...
    print("=" * 70)
    print("Multi-Parameter Experiment: Experiment 2 (A -> C)")
    print("=" * 70)
